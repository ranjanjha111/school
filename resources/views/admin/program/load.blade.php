        ...
        <table class="table table-striped jambo_table bulk_action">
            <thead>
                <tr class="headings">
                    ...
                    <th class="column-title col-md-2">Program</th>
                    <th class="column-title col-md-2">Time(From - to)</th>
                    <th class="column-title col-md-2">Banner</th>
                    <th class="column-title col-md-2">Status</th>
                    @can('view_programs', 'edit_programs', 'delete_programs')
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="col-md-2">{{ $item->time_from ." - ". $item->time_to}}</td>
                    <td class="col-md-2">
                        <img src="{{url(\App\Program::THUMB_DIR . $item->banner)}}" alt="Program image" width="45" height="45">
                    </td>
                    <td class="col-md-2">{{ ($item->status == 1) ? 'Active' : 'Inactive' }}</td>
                    @can('view_programs', 'edit_programs', 'delete_programs')
                        @include('admin.shared._actions', ['entity' => 'programs', 'id' => $item->id])
                    @endcan
                </tr>
            @endforeach
            </tbody>
