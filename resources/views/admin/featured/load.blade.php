        ...
        <table class="table table-striped jambo_table bulk_action">
            <thead>
                <tr class="headings">
                    ...
                    @can('view_featureds', 'edit_featureds', 'delete_featureds')
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="col-md-2">
                        <img src="{{url(\App\Featured::THUMB_DIR . $item->image)}}" alt="Team" width="45" height="45">
                    </td>
                    <td class="col-md-1">{{ ($item->status == 1) ? 'Active' : 'Inactive' }}</td>

                    @can('view_featureds', 'edit_featureds', 'delete_featureds')
                        @include('admin.shared._actions', ['entity' => 'featureds', 'id' => $item->id])
                    @endcan
                </tr>
            @endforeach
            </tbody>
