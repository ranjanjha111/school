    ...
    <div class="table-responsive">
        <table class="table table-striped jambo_table bulk_action">
            ...
            <tr class="headings">
                ...
                <th class="column-title col-md-7">State</th>
                ...
                <tr>
                    ...
                    @can('view_users', 'edit_users', 'delete_users')
                        <td class="text-center col-md-3">
                            ...
                            @can('delete_users')
                                {!! Form::open( ['method' => 'delete', 'url' => route('states.destroy', ['id' => $item->id]), 'style' => 'display: inline']) !!}
                                    ...
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel2">Delete State</h4>
                                            </div>
